...
export function getPicCode() {
    return service.request({
        method: "post",
        url: "admin/translate/getpiccode",
        data: {},
    });
}
 ...
 * @returns
 */
export function getPhoneCode(phone, picCode) {
    return service.request({
        method: "post",
        url: "admin/translate/getcode",
        data: {
            picCode: picCode,
            phone: phone,
        },
 ...
 * @returns
 */
export function registerUser(phone, phoneCode, password) {
    return service.request({
        method: "post",
        url: "admin/translate/user/register",
        data: {
            phone: phone,
            phoneCode: phoneCode,
            password: password,
...
export function searchIpInfo(ip) {
    return service.request({
        ...
        url:
            "api/ip/aim_ip?app_id=xgjftdiauwetheop&app_secret=NlBselBJVUdDOVZKKyt5MXU0Ym5lUT09&ip=" +
            ip,
        data: {},
    });
}
